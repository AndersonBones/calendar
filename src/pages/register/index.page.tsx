...
const registerSchema = z.object({
    username: z.string().min(3, { message: 'digite pelo menos 3 caracteres' })
        .regex(/^([a-z\\-]+)$/i, {
            message: "o usuário pode conter apenas letras, numeros e hifens."
        }),
    name: z.string().min(4, { message: 'digite pelo menos 4 letras' })
        .regex(/[a-zA-Z ]+/, {
...
export default function Register() {
    const { register, handleSubmit, setValue, formState: { errors, isSubmitting } } = useForm<TRegister>({
    ...
    return (
        <Container>
            ...
            <Form as="form" onSubmit={handleSubmit(handleRegister)}>
                ...
                <Button disabled={isSubmitting} variant={"secondary"} size="sm" type="submit">Próximo passo <ArrowRight /></Button>
            </Form>
